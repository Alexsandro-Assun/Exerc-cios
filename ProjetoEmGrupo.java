	...
	public static void main(String[] args) {
		 ...
		 String nome = null;
		    ...
		    int[][] array = new int[6][6];
				...
				System.out.println("Faça seu cadastro com uma senha(apenas números): ");
				num = ler.nextInt();
				senha = num;
			...
			System.out.println("Jogue o mini dado virtual ");
			...
			System.out.println("Irei te conduzir em uma análise para que você também possa descobrir se divertir e se conhecer um pouco mais ");
		    System.out.println();
